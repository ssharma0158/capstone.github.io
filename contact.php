...
<br>
  ...
  <button type="submit" class="btn btn-secondary btn_">Submit</button>
</form>
    </div>
    <div class="col">
      <div class ="formjay">
          <h2>Dream Team Members</h2>

          <ul class="a">
  <li>Mamta Pourh - mpourh5087@conestogac.on.ca</li>
  <li>Jay Patel - Jpatel0522@conestogac.on.ca</li>
  <li>Gagandeep Kaur - Gagandeepkaur7234@conestogac.on.ca</li>
  <li>Sandeep Sharma - Ssharma0158@conestogac.on.ca</li>
 </ul>

 <h3 class="clg">College Name and Address</h3>
 <br>

 <p class="clg"> Conestoga College</p>
 
 <p class="clg"> 299 Doon Valley Drive
...
<!-- Grid container -->
<div class="container p-4 pb-0 icons">
      <!-- Section: Social media -->
      <section class="mb-4">
        <!-- Facebook -->
        <a class="btn btn-outline-light btn-floating m-1" href="#!" role="button" style="color:black"
